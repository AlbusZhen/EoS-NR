...
/*
 * $Id: examrot_dirac.C,v 1.4 2022/02/10 10:45:49 j_novak Exp $
 * $Log: examrot_dirac.C,v $
 * Revision 1.4  2022/02/10 10:45:49  j_novak
 * Removed some not needed output
 *
 ...
 *
 *
 * $Header: /cvsroot/Lorene/Codes/Rot_star/examrot_dirac.C,v 1.4 2022/02/10 10:45:49 j_novak Exp $
 *
 */
...
int main(int argc, char** argv){
  ...
  des_coupe_y(star.get_lnq(), 0., nzet, "Metric potential ln(Q)", &surf,
	      zoom, draw_bound) ;
	
  des_coupe_y(star.get_aa_quad(), 0., nzet, "A\\uij\\d A\\dij", &surf,
	      zoom, draw_bound) ;
  ...
  des_coupe_y(star.get_hh()(2,2), 0., nzet, "Metric potential h\\u\\gh\\gh",
	      &surf) ; 
  des_coupe_y(star.get_hh()(3,3), 0., nzet, "Metric potential h\\u\\gf\\gf",
	      &surf) ; 
