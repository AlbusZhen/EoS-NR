...
/*
 * $Id: des_profile_log.C,v 1.1 2022/02/10 16:33:53 j_novak Exp $
 * $Log: des_profile_log.C,v $
 * Revision 1.1  2022/02/10 16:33:53  j_novak
 * New drawing functions with logscale in y : des_profile_log, des_meridian_log.
 *
 *
 * $Header: /cvsroot/Lorene/C++/Source/Non_class_members/Graphics/des_profile_log.C,v 1.1 2022/02/10 16:33:53 j_novak Exp $
 *
 */
