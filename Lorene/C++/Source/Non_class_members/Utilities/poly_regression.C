...
/*
 * $Id: poly_regression.C,v 1.1 2022/04/15 13:39:25 j_novak Exp $
 * $Log: poly_regression.C,v $
 * Revision 1.1  2022/04/15 13:39:25  j_novak
 * New class Eos_compose_fit to generate fitted EoSs from CompOSE tables.
 *
 *
 * $Header: /cvsroot/Lorene/C++/Source/Non_class_members/Utilities/poly_regression.C,v 1.1 2022/04/15 13:39:25 j_novak Exp $
 *
 */
